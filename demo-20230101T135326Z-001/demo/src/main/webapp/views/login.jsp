...
<body onload="time()">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                      <img src="views/images/Customer-Supprt.png" alt="IMG">
                </div>
                ...
                <form class="login100-form validate-form">
                    ...
                    <form action="views/custommer.html">
                ...
                <div class="text-center p-t-12">
                    ...
                    <a class="txt2" href="views/tim-lai-mat-khau.html">
                        Tài khoản / mật khẩu?
                    </a>
                </div>
   ...
   <script type="views/text/javascript">
    function validate() {
